...
// checks if the AdvancedDecisionEvaluationInstanceKeyFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvancedDecisionEvaluationInstanceKeyFilter{}
...
func NewAdvancedDecisionEvaluationInstanceKeyFilter() *AdvancedDecisionEvaluationInstanceKeyFilter {
	this := AdvancedDecisionEvaluationInstanceKeyFilter{}
	return &this
}

// NewAdvancedDecisionEvaluationInstanceKeyFilterWithDefaults instantiates a new AdvancedDecisionEvaluationInstanceKeyFilter object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAdvancedDecisionEvaluationInstanceKeyFilterWithDefaults() *AdvancedDecisionEvaluationInstanceKeyFilter {
	this := AdvancedDecisionEvaluationInstanceKeyFilter{}
	return &this
}
...
func (o *AdvancedDecisionEvaluationInstanceKeyFilter) HasEq() bool {
	if o != nil && !IsNil(o.Eq) {
		return true
	}
...
func (o *AdvancedDecisionEvaluationInstanceKeyFilter) HasNeq() bool {
	if o != nil && !IsNil(o.Neq) {
		return true
	}
...
func (o *AdvancedDecisionEvaluationInstanceKeyFilter) GetExists() bool {
...
// and a boolean to check if the value has been set.
func (o *AdvancedDecisionEvaluationInstanceKeyFilter) GetExistsOk() (*bool, bool) {
	if o == nil || IsNil(o.Exists) {
		return nil, false
	}
...
func (o *AdvancedDecisionEvaluationInstanceKeyFilter) HasExists() bool {
	if o != nil && !IsNil(o.Exists) {
		return true
	}
...
func (o *AdvancedDecisionEvaluationInstanceKeyFilter) SetExists(v bool) {
	o.Exists = &v
}
...
func (o *AdvancedDecisionEvaluationInstanceKeyFilter) HasIn() bool {
	if o != nil && !IsNil(o.In) {
		return true
	}
...
func (o *AdvancedDecisionEvaluationInstanceKeyFilter) HasNotIn() bool {
	if o != nil && !IsNil(o.NotIn) {
		return true
	}
...
func (o AdvancedDecisionEvaluationInstanceKeyFilter) MarshalJSON() ([]byte, error) {
...
func (o AdvancedDecisionEvaluationInstanceKeyFilter) ToMap() (map[string]interface{}, error) {
...
type NullableAdvancedDecisionEvaluationInstanceKeyFilter struct {
	value *AdvancedDecisionEvaluationInstanceKeyFilter
	isSet bool
}

func (v NullableAdvancedDecisionEvaluationInstanceKeyFilter) Get() *AdvancedDecisionEvaluationInstanceKeyFilter {
	return v.value
}

func (v *NullableAdvancedDecisionEvaluationInstanceKeyFilter) Set(val *AdvancedDecisionEvaluationInstanceKeyFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvancedDecisionEvaluationInstanceKeyFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvancedDecisionEvaluationInstanceKeyFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvancedDecisionEvaluationInstanceKeyFilter(val *AdvancedDecisionEvaluationInstanceKeyFilter) *NullableAdvancedDecisionEvaluationInstanceKeyFilter {
	return &NullableAdvancedDecisionEvaluationInstanceKeyFilter{value: val, isSet: true}
}

func (v NullableAdvancedDecisionEvaluationInstanceKeyFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvancedDecisionEvaluationInstanceKeyFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
