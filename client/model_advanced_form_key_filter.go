...
// checks if the AdvancedFormKeyFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvancedFormKeyFilter{}
...
func NewAdvancedFormKeyFilter() *AdvancedFormKeyFilter {
	this := AdvancedFormKeyFilter{}
	return &this
}

// NewAdvancedFormKeyFilterWithDefaults instantiates a new AdvancedFormKeyFilter object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAdvancedFormKeyFilterWithDefaults() *AdvancedFormKeyFilter {
	this := AdvancedFormKeyFilter{}
	return &this
}
...
func (o *AdvancedFormKeyFilter) HasEq() bool {
	if o != nil && !IsNil(o.Eq) {
		return true
	}
...
func (o *AdvancedFormKeyFilter) HasNeq() bool {
	if o != nil && !IsNil(o.Neq) {
		return true
	}
...
func (o *AdvancedFormKeyFilter) GetExists() bool {
...
// and a boolean to check if the value has been set.
func (o *AdvancedFormKeyFilter) GetExistsOk() (*bool, bool) {
	if o == nil || IsNil(o.Exists) {
		return nil, false
	}
...
func (o *AdvancedFormKeyFilter) HasExists() bool {
	if o != nil && !IsNil(o.Exists) {
		return true
	}
...
func (o *AdvancedFormKeyFilter) SetExists(v bool) {
	o.Exists = &v
}
...
func (o *AdvancedFormKeyFilter) HasIn() bool {
	if o != nil && !IsNil(o.In) {
		return true
	}
...
func (o *AdvancedFormKeyFilter) HasNotIn() bool {
	if o != nil && !IsNil(o.NotIn) {
		return true
	}
...
func (o AdvancedFormKeyFilter) MarshalJSON() ([]byte, error) {
...
func (o AdvancedFormKeyFilter) ToMap() (map[string]interface{}, error) {
...
type NullableAdvancedFormKeyFilter struct {
	value *AdvancedFormKeyFilter
	isSet bool
}

func (v NullableAdvancedFormKeyFilter) Get() *AdvancedFormKeyFilter {
	return v.value
}

func (v *NullableAdvancedFormKeyFilter) Set(val *AdvancedFormKeyFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvancedFormKeyFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvancedFormKeyFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvancedFormKeyFilter(val *AdvancedFormKeyFilter) *NullableAdvancedFormKeyFilter {
	return &NullableAdvancedFormKeyFilter{value: val, isSet: true}
}

func (v NullableAdvancedFormKeyFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvancedFormKeyFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
