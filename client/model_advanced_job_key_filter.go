...
// checks if the AdvancedJobKeyFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvancedJobKeyFilter{}
...
func NewAdvancedJobKeyFilter() *AdvancedJobKeyFilter {
	this := AdvancedJobKeyFilter{}
	return &this
}

// NewAdvancedJobKeyFilterWithDefaults instantiates a new AdvancedJobKeyFilter object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAdvancedJobKeyFilterWithDefaults() *AdvancedJobKeyFilter {
	this := AdvancedJobKeyFilter{}
	return &this
}
...
func (o *AdvancedJobKeyFilter) HasEq() bool {
	if o != nil && !IsNil(o.Eq) {
		return true
	}
...
func (o *AdvancedJobKeyFilter) HasNeq() bool {
	if o != nil && !IsNil(o.Neq) {
		return true
	}
...
func (o *AdvancedJobKeyFilter) GetExists() bool {
...
// and a boolean to check if the value has been set.
func (o *AdvancedJobKeyFilter) GetExistsOk() (*bool, bool) {
	if o == nil || IsNil(o.Exists) {
		return nil, false
	}
...
func (o *AdvancedJobKeyFilter) HasExists() bool {
	if o != nil && !IsNil(o.Exists) {
		return true
	}
...
func (o *AdvancedJobKeyFilter) SetExists(v bool) {
	o.Exists = &v
}
...
func (o *AdvancedJobKeyFilter) HasIn() bool {
	if o != nil && !IsNil(o.In) {
		return true
	}
...
func (o *AdvancedJobKeyFilter) HasNotIn() bool {
	if o != nil && !IsNil(o.NotIn) {
		return true
	}
...
func (o AdvancedJobKeyFilter) MarshalJSON() ([]byte, error) {
...
func (o AdvancedJobKeyFilter) ToMap() (map[string]interface{}, error) {
...
type NullableAdvancedJobKeyFilter struct {
	value *AdvancedJobKeyFilter
	isSet bool
}

func (v NullableAdvancedJobKeyFilter) Get() *AdvancedJobKeyFilter {
	return v.value
}

func (v *NullableAdvancedJobKeyFilter) Set(val *AdvancedJobKeyFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvancedJobKeyFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvancedJobKeyFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvancedJobKeyFilter(val *AdvancedJobKeyFilter) *NullableAdvancedJobKeyFilter {
	return &NullableAdvancedJobKeyFilter{value: val, isSet: true}
}

func (v NullableAdvancedJobKeyFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvancedJobKeyFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
