...
// checks if the AdvancedDecisionEvaluationKeyFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvancedDecisionEvaluationKeyFilter{}
...
func NewAdvancedDecisionEvaluationKeyFilter() *AdvancedDecisionEvaluationKeyFilter {
	this := AdvancedDecisionEvaluationKeyFilter{}
	return &this
}

// NewAdvancedDecisionEvaluationKeyFilterWithDefaults instantiates a new AdvancedDecisionEvaluationKeyFilter object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAdvancedDecisionEvaluationKeyFilterWithDefaults() *AdvancedDecisionEvaluationKeyFilter {
	this := AdvancedDecisionEvaluationKeyFilter{}
	return &this
}
...
func (o *AdvancedDecisionEvaluationKeyFilter) HasEq() bool {
	if o != nil && !IsNil(o.Eq) {
		return true
	}
...
func (o *AdvancedDecisionEvaluationKeyFilter) HasNeq() bool {
	if o != nil && !IsNil(o.Neq) {
		return true
	}
...
func (o *AdvancedDecisionEvaluationKeyFilter) GetExists() bool {
...
// and a boolean to check if the value has been set.
func (o *AdvancedDecisionEvaluationKeyFilter) GetExistsOk() (*bool, bool) {
	if o == nil || IsNil(o.Exists) {
		return nil, false
	}
...
func (o *AdvancedDecisionEvaluationKeyFilter) HasExists() bool {
	if o != nil && !IsNil(o.Exists) {
		return true
	}
...
func (o *AdvancedDecisionEvaluationKeyFilter) SetExists(v bool) {
	o.Exists = &v
}
...
func (o *AdvancedDecisionEvaluationKeyFilter) HasIn() bool {
	if o != nil && !IsNil(o.In) {
		return true
	}
...
func (o *AdvancedDecisionEvaluationKeyFilter) HasNotIn() bool {
	if o != nil && !IsNil(o.NotIn) {
		return true
	}
...
func (o AdvancedDecisionEvaluationKeyFilter) MarshalJSON() ([]byte, error) {
...
func (o AdvancedDecisionEvaluationKeyFilter) ToMap() (map[string]interface{}, error) {
...
type NullableAdvancedDecisionEvaluationKeyFilter struct {
	value *AdvancedDecisionEvaluationKeyFilter
	isSet bool
}

func (v NullableAdvancedDecisionEvaluationKeyFilter) Get() *AdvancedDecisionEvaluationKeyFilter {
	return v.value
}

func (v *NullableAdvancedDecisionEvaluationKeyFilter) Set(val *AdvancedDecisionEvaluationKeyFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvancedDecisionEvaluationKeyFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvancedDecisionEvaluationKeyFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvancedDecisionEvaluationKeyFilter(val *AdvancedDecisionEvaluationKeyFilter) *NullableAdvancedDecisionEvaluationKeyFilter {
	return &NullableAdvancedDecisionEvaluationKeyFilter{value: val, isSet: true}
}

func (v NullableAdvancedDecisionEvaluationKeyFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvancedDecisionEvaluationKeyFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
