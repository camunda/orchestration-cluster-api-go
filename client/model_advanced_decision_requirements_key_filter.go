...
// checks if the AdvancedDecisionRequirementsKeyFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvancedDecisionRequirementsKeyFilter{}
...
func NewAdvancedDecisionRequirementsKeyFilter() *AdvancedDecisionRequirementsKeyFilter {
	this := AdvancedDecisionRequirementsKeyFilter{}
	return &this
}

// NewAdvancedDecisionRequirementsKeyFilterWithDefaults instantiates a new AdvancedDecisionRequirementsKeyFilter object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAdvancedDecisionRequirementsKeyFilterWithDefaults() *AdvancedDecisionRequirementsKeyFilter {
	this := AdvancedDecisionRequirementsKeyFilter{}
	return &this
}
...
func (o *AdvancedDecisionRequirementsKeyFilter) HasEq() bool {
	if o != nil && !IsNil(o.Eq) {
		return true
	}
...
func (o *AdvancedDecisionRequirementsKeyFilter) HasNeq() bool {
	if o != nil && !IsNil(o.Neq) {
		return true
	}
...
func (o *AdvancedDecisionRequirementsKeyFilter) GetExists() bool {
...
// and a boolean to check if the value has been set.
func (o *AdvancedDecisionRequirementsKeyFilter) GetExistsOk() (*bool, bool) {
	if o == nil || IsNil(o.Exists) {
		return nil, false
	}
...
func (o *AdvancedDecisionRequirementsKeyFilter) HasExists() bool {
	if o != nil && !IsNil(o.Exists) {
		return true
	}
...
func (o *AdvancedDecisionRequirementsKeyFilter) SetExists(v bool) {
	o.Exists = &v
}
...
func (o *AdvancedDecisionRequirementsKeyFilter) HasIn() bool {
	if o != nil && !IsNil(o.In) {
		return true
	}
...
func (o *AdvancedDecisionRequirementsKeyFilter) HasNotIn() bool {
	if o != nil && !IsNil(o.NotIn) {
		return true
	}
...
func (o AdvancedDecisionRequirementsKeyFilter) MarshalJSON() ([]byte, error) {
...
func (o AdvancedDecisionRequirementsKeyFilter) ToMap() (map[string]interface{}, error) {
...
type NullableAdvancedDecisionRequirementsKeyFilter struct {
	value *AdvancedDecisionRequirementsKeyFilter
	isSet bool
}

func (v NullableAdvancedDecisionRequirementsKeyFilter) Get() *AdvancedDecisionRequirementsKeyFilter {
	return v.value
}

func (v *NullableAdvancedDecisionRequirementsKeyFilter) Set(val *AdvancedDecisionRequirementsKeyFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvancedDecisionRequirementsKeyFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvancedDecisionRequirementsKeyFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvancedDecisionRequirementsKeyFilter(val *AdvancedDecisionRequirementsKeyFilter) *NullableAdvancedDecisionRequirementsKeyFilter {
	return &NullableAdvancedDecisionRequirementsKeyFilter{value: val, isSet: true}
}

func (v NullableAdvancedDecisionRequirementsKeyFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvancedDecisionRequirementsKeyFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
