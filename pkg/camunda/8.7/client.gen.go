// Package camunda87 provides primitives to interact with the openapi HTTP API.
//
...
// Valid indicates whether the value is a known member of the DocumentReferenceBaseCamundaDocumentType enum.
func (e DocumentReferenceBaseCamundaDocumentType) Valid() bool {
	switch e {
	case Camunda:
		return true
	default:
...
// Valid indicates whether the value is a known member of the IncidentFilterRequestBaseErrorType enum.
func (e IncidentFilterRequestBaseErrorType) Valid() bool {
	switch e {
	case IncidentFilterRequestBaseErrorTypeCALLEDDECISIONERROR:
		return true
	case IncidentFilterRequestBaseErrorTypeCALLEDELEMENTERROR:
		return true
	case IncidentFilterRequestBaseErrorTypeCONDITIONERROR:
		return true
	case IncidentFilterRequestBaseErrorTypeDECISIONEVALUATIONERROR:
		return true
	case IncidentFilterRequestBaseErrorTypeEXECUTIONLISTENERNORETRIES:
		return true
	case IncidentFilterRequestBaseErrorTypeEXTRACTVALUEERROR:
		return true
	case IncidentFilterRequestBaseErrorTypeFORMNOTFOUND:
		return true
	case IncidentFilterRequestBaseErrorTypeIOMAPPINGERROR:
		return true
	case IncidentFilterRequestBaseErrorTypeJOBNORETRIES:
		return true
	case IncidentFilterRequestBaseErrorTypeMESSAGESIZEEXCEEDED:
		return true
	case IncidentFilterRequestBaseErrorTypeRESOURCENOTFOUND:
		return true
	case IncidentFilterRequestBaseErrorTypeUNHANDLEDERROREVENT:
		return true
	case IncidentFilterRequestBaseErrorTypeUNKNOWN:
		return true
	case IncidentFilterRequestBaseErrorTypeUNSPECIFIED:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the IncidentFilterRequestBaseState enum.
func (e IncidentFilterRequestBaseState) Valid() bool {
	switch e {
	case IncidentFilterRequestBaseStateACTIVE:
		return true
	case IncidentFilterRequestBaseStateMIGRATED:
		return true
	case IncidentFilterRequestBaseStatePENDING:
		return true
	case IncidentFilterRequestBaseStateRESOLVED:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the IncidentItemBaseErrorType enum.
func (e IncidentItemBaseErrorType) Valid() bool {
	switch e {
	case IncidentItemBaseErrorTypeCALLEDDECISIONERROR:
		return true
	case IncidentItemBaseErrorTypeCALLEDELEMENTERROR:
		return true
	case IncidentItemBaseErrorTypeCONDITIONERROR:
		return true
	case IncidentItemBaseErrorTypeDECISIONEVALUATIONERROR:
		return true
	case IncidentItemBaseErrorTypeEXECUTIONLISTENERNORETRIES:
		return true
	case IncidentItemBaseErrorTypeEXTRACTVALUEERROR:
		return true
	case IncidentItemBaseErrorTypeFORMNOTFOUND:
		return true
	case IncidentItemBaseErrorTypeIOMAPPINGERROR:
		return true
	case IncidentItemBaseErrorTypeJOBNORETRIES:
		return true
	case IncidentItemBaseErrorTypeMESSAGESIZEEXCEEDED:
		return true
	case IncidentItemBaseErrorTypeRESOURCENOTFOUND:
		return true
	case IncidentItemBaseErrorTypeUNHANDLEDERROREVENT:
		return true
	case IncidentItemBaseErrorTypeUNKNOWN:
		return true
	case IncidentItemBaseErrorTypeUNSPECIFIED:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the IncidentItemBaseState enum.
func (e IncidentItemBaseState) Valid() bool {
	switch e {
	case IncidentItemBaseStateACTIVE:
		return true
	case IncidentItemBaseStateMIGRATED:
		return true
	case IncidentItemBaseStatePENDING:
		return true
	case IncidentItemBaseStateRESOLVED:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the OperationItemState enum.
func (e OperationItemState) Valid() bool {
	switch e {
	case OperationItemStateCOMPLETED:
		return true
	case OperationItemStateFAILED:
		return true
	case OperationItemStateLOCKED:
		return true
	case OperationItemStateSCHEDULED:
		return true
	case OperationItemStateSENT:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the OperationItemType enum.
func (e OperationItemType) Valid() bool {
	switch e {
	case ADDVARIABLE:
		return true
	case CANCELPROCESSINSTANCE:
		return true
	case DELETEDECISIONDEFINITION:
		return true
	case DELETEPROCESSDEFINITION:
		return true
	case DELETEPROCESSINSTANCE:
		return true
	case MIGRATEPROCESSINSTANCE:
		return true
...
// Valid indicates whether the value is a known member of the PartitionHealth enum.
func (e PartitionHealth) Valid() bool {
	switch e {
	case Dead:
		return true
	case Healthy:
...
// Valid indicates whether the value is a known member of the PartitionRole enum.
func (e PartitionRole) Valid() bool {
	switch e {
	case Follower:
		return true
	case Inactive:
...
// Valid indicates whether the value is a known member of the ProcessInstanceItemBaseState enum.
func (e ProcessInstanceItemBaseState) Valid() bool {
	switch e {
	case ProcessInstanceItemBaseStateACTIVE:
		return true
	case ProcessInstanceItemBaseStateCANCELED:
		return true
	case ProcessInstanceItemBaseStateCOMPLETED:
		return true
	case ProcessInstanceItemBaseStateINCIDENT:
		return true
	case ProcessInstanceItemBaseStateUNKNOWN:
		return true
	case ProcessInstanceItemBaseStateUNSPECIFIED:
		return true
	default:
		return false
	}
...
func NewGetDecisionDefinitionsDecisionDefinitionKeyXmlRequest(server string, decisionDefinitionKey string) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "decisionDefinitionKey", decisionDefinitionKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewCreateDocumentRequestWithBody(server string, params *CreateDocumentParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.StoreId != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "storeId", *params.StoreId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
		...
		if params.DocumentId != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "documentId", *params.DocumentId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewGetDocumentRequest(server string, documentId string, params *GetDocumentParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.ContentHash != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "contentHash", *params.ContentHash, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewPutElementInstancesElementInstanceKeyVariablesRequestWithBody(server string, elementInstanceKey string, contentType string, body io.Reader) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "elementInstanceKey", elementInstanceKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewGetIncidentsIncidentKeyRequest(server string, incidentKey string) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "incidentKey", incidentKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewPatchJobsJobKeyRequestWithBody(server string, jobKey string, contentType string, body io.Reader) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "jobKey", jobKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewPostProcessInstancesProcessInstanceKeyCancellationRequestWithBody(server string, processInstanceKey string, contentType string, body io.Reader) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "processInstanceKey", processInstanceKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewGetResourcesResourceKeyRequest(server string, resourceKey string) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "resourceKey", resourceKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewPatchUserTasksUserTaskKeyRequestWithBody(server string, userTaskKey string, contentType string, body io.Reader) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "userTaskKey", userTaskKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
