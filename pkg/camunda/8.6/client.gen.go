// Package camunda86 provides primitives to interact with the openapi HTTP API.
//
...
// Valid indicates whether the value is a known member of the DocumentReferenceDocumentType enum.
func (e DocumentReferenceDocumentType) Valid() bool {
	switch e {
	case Camunda:
		return true
	default:
...
func NewGetDecisionDefinitionsDecisionDefinitionKeyXmlRequest(server string, decisionDefinitionKey int64) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "decisionDefinitionKey", decisionDefinitionKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
...
func NewPutElementInstancesElementInstanceKeyVariablesRequestWithBody(server string, elementInstanceKey int64, contentType string, body io.Reader) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "elementInstanceKey", elementInstanceKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
...
func NewPostResourcesResourceKeyDeletionRequestWithBody(server string, resourceKey int64, contentType string, body io.Reader) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "resourceKey", resourceKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
...
func NewPatchUserTasksUserTaskKeyRequestWithBody(server string, userTaskKey int64, contentType string, body io.Reader) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "userTaskKey", userTaskKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
